...
PROP.kappa11 = 2e-12;            %m^2   Permeability
PROP.kappa22 = 2e-12;            %m^2
PROP.viscosity = 1.0e-3;        %Pa*s        0.0010005 Pa*s
PROP.N = 1e-5;                        %Biot's skeleton modulus
...
PROP.leakoff = 5.879e-18;             %m/(Pa*s)   Leak off coefficient  5.879e-3 is a good number
