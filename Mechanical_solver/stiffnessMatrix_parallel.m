...
function  stiffnessMatrix_parallel(PROP,LTAN,NLTAN,NEQ)
...
[Rhs, StiffnessMatrix]=parallel_for(CONNEC, NODES, PSI, XYZ, STATEV, DISPDD, DISPTD, FORCE, GKF, connec_frac, xyz_frac, statev_frac, LocalElement,PROP,LTAN,NLTAN,NEQ);
...
function [Rhs, StiffnessMatrix] = parallel_for(CONNEC, NODES, PSI, XYZ, STATEV, DISPDD, DISPTD, FORCE, GKF, connec_frac, xyz_frac, statev_frac, LocalElement,PROP,LTAN,NLTAN,NEQ)

StiffnessMatrix = GKF;
Rhs = FORCE;
fcn = @plus;

parfor iElem= 1:size(CONNEC,1)
...
%                 FORCE(localD_enr) = FORCE(localD_enr) - W*detJ_frac*NT'*lambda*Traction;
                ...
                Felement = - W*detJ_frac*NT'*lambda'*Traction ;
